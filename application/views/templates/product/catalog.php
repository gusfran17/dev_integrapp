<div id="page-wrapper" >
	<div class="container" id="main-products">
    	...
    	<div class="row" style="padding: 10px 10px 10px 10px;">
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="margin-top: 0% !important">
				<div class="well bs-component" style="margin-top: 0% !important">
			...
			<div class="row col-lg-7 col-md-7 col-sm-10 col-xs-12" style="margin-top: 0% !important">
				<?php if ($viewType == "tilesView") { 
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 publicidad" style="margin-top: 0% !important"><img src="banner.jpg" width="160" height="600">
			</div>
			<div class="col-md-12 col-sm-12 col-xs-12" style="text-align:center">
				<?php if(isset($pageLinks)) foreach ($pageLinks as $link) {
					echo $link;
