				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="well well-small pnlSupplier" style="padding-top: 0px; text-align: center;">
							...
							<?php if ($supplier->commercial_address != "") echo "<b>Dirección: </b>" . $supplier->commercial_address . "<br>";?>
							<?php if ($supplier->contact_phone != "") echo "<b>Teléfono: </b>" . $supplier->contact_phone . "<br>";?>
