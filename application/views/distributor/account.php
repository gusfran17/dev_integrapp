				...
				<div class="panel-body">
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">				
						...
						<div class="form-group">
						  ...
						  <input class="form-control" id="working_hours" name="working_hours" type="text" placeHolder="Ej. Lun. a Vier (8:00 a 18:00) Sab. (8:00 a 13:00)" value="<?php if (isset($distributor)) echo set_value('working_hours', $distributor->working_hours); else echo set_value('working_hours'); ?>">
						</div>
