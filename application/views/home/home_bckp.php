		...
		<div id="carousel_home" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner" role="listbox">
			    <div class="item active">
			        <img src="<?php echo base_url(); ?>/Resources/img/1.png" alt="..." style="margin: left;">
			    </div>
				<div class="item">
					<img src="<?php echo base_url(); ?>/Resources/img/2.png" alt="..." style="margin: left;">
				</div>
				<div class="item">
				    <img src="<?php echo base_url(); ?>/Resources/img/3.png" alt="..." style="margin: left;">
				</div>
			</div>
		</div>
			...
			<header>
				<div class="row">
					...
					<div class="col-md-7" id="banner">
						<figure>
							<img src="<?php echo base_url(); ?>/Resources/img/banner.jpg" alt="">
						</figure>
					</div>
				</div>
			</header>
