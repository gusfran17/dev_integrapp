<section id="home">
	...
	<form class="region size1of2" action="/perfil/guardar" method="post" id="frm-login">
		...
		<div class="form-group">
		  <label class="control-label" for="fake_name">Nombre de Usuario</label>
		  <input class="form-control" id="fake_name" name="fake_name" type="text" placeHolder="Escriba el nombre de fantasía." value="<?php echo set_value('fake_name', $user->username); ?>">
		</div>
